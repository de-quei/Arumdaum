...
public class MBookStatusFrame extends JFrame{
    ...
    String[] header = {"번호", "도서명", "ISBN", "출판사", "저자", "수량"};
    String[][] contents = {};
	...
	private void addComponentsUI() {
		...
		borderPanel.setBorder(new TitledBorder(new LineBorder(Color.BLACK), "도서 현황"));
	...
	private void loadDataFromDatabase() {
        try {
            ...
            while (resultSet.next()) {
                ...
                tableModel.addRow(new String[]{bookId, bookName, isbn, publisher, author, status});
            }
